    ...
    <footer className="mt-20 border-t border-border/60 bg-secondary/40">
      <div className="max-w-6xl mx-auto px-4 py-10 grid sm:grid-cols-3 gap-8 text-sm">
        <div>
          ...
          <p className="text-muted-foreground">Gaon ke logon ke liye ek simple, bharosemand food delivery platform. WhatsApp se order, ghar tak swad.</p>
        </div>
        <div>
        ...
        <div>
          ...
          <p className="text-muted-foreground">WhatsApp: <a href="https://wa.me/918078633912" className="text-primary font-medium">+91 80786 33912</a></p>
